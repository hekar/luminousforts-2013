...
void IN_DropFlagDown( const CCommand &args ) { KeyDown( &in_dropflag, args[1] ); }
...
int CInput::GetButtonBits( int bResetState )
{
	...
	CalcButtonBits( bits, IN_DROPFLAG, s_ClearInputState, &in_dropflag, bResetState );
...
static ConCommand startdropflag("+dropflag", IN_DropFlagDown);
static ConCommand enddropflag( "-dropflag", IN_DropFlagUp );
