...
class CCreditPanel : public MFrame
{
private:
	DECLARE_CLASS_SIMPLE( CCreditPanel, MFrame );

public:
	CCreditPanel (vgui::VPANEL parent);
	~CCreditPanel ();
...
DEFINE_GUI_INTERFACE(CCreditPanel,CreditInterface,creditspanel)
