	...
	public:
		...
		virtual IterationRetval_t EnumElement( IHandleEntity *pHandleEntity )
		{
			...
			if ( pEntity &&
				 ...
				 ( pEntity->VPhysicsGetObject()->IsMoveable() || pEntity->GetHealth() > 0 ) )
			{
...
void CNPC_BaseZombie::Spawn( void )
{
	...
	m_AssaultBehavior.SetParameters( FindPooledString( "assault" ), CUE_DONT_WAIT, RALLY_POINT_SELECT_DEFAULT );
}
